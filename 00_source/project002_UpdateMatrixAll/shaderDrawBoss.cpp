//============================================================
//
//	ボス描画シェーダーヘッダー [shaderDrawBoss.cpp]
//	Author：藤田勇一
//
//============================================================
//************************************************************
...
//	静的メンバ変数宣言
//************************************************************
CDrawBossShader *CDrawBossShader::m_pShader = nullptr;	// シェーダー情報

//************************************************************
//	親クラス [CDrawBossShader] のメンバ関数
//************************************************************
//============================================================
//	コンストラクタ
//============================================================
CDrawBossShader::CDrawBossShader() :
	...
	m_pTextureCrop	(nullptr),	// 切り抜きテクスチャ
...
HRESULT CDrawBossShader::Init(void)
{
	...
	{ // 頂点・ピクセルシェーダのバージョンが使用可能な場合
		...
		{ // 読込に成功した場合
			...
			m_pTextureCrop	= pEffect->GetParameterByName(nullptr, "g_textureCrop");	// 切り抜きテクスチャ
